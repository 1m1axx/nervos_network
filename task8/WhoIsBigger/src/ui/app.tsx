...
export function App() {
    ...
    async function getStoredValue() {
        ...
        toast('Successfully compare who is bigger.', { type: 'success' });
    ...
    async function setNewStoredValue() {
        try {
            ...
            toast(
                'Successfully input number. You can view result now manually.',
                { type: 'success' }
            );
        } catch (error) {
            console.error(error);
    ...
    return (
        <div>
            ...
            <hr />
            <p>
                The button below will deploy a 💪💪Who is bigger? smart contract where you can guess a
